import './views/templates/components/restaurant-item'
import Data from './data'

const btnHamburger = document.querySelector('#hamburgerButton')
const hamburgerList = document.querySelector('#navigationDrawer ul')
const hamburgerListWrapper = document.querySelector('#navigationDrawer')
